...
CKEDITOR.plugins.addExternal( 'mdc_ad', '/vendor/pub/editor/js/ckeditor_plugins/mdc_ad/' );
CKEDITOR.plugins.addExternal( 'g3n1us_component', '/vendor/pub/editor/js/ckeditor_plugins/g3n1us_component/' );
CKEDITOR.plugins.addExternal( 'article_embed', '/vendor/pub/editor/js/ckeditor_plugins/article_embed/' );
CKEDITOR.config.embed_provider = '//iframe.ly/api/oembed?url={url}&callback={callback}&api_key=' + iframelyapikey;
	...
	$('.editor').each(function(e){
		if($(this).hasClass('advanced-only')){
			...
			$(this).ckeditor({
				...
				contentsCss: ['https://fonts.googleapis.com/css?family=Roboto+Slab:300,400,700', '/vendor/pub/editor/css/ckeditor.css'],
...
// 				imageUploadUrl : "/dashboard/upload/1/"+article_id,
				...
				templates_files: [ '/vendor/pub/editor/js/ckeditor_templates.js' ],
