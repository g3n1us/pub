var _self="undefined"!=typeof window?window:"undefined"!=typeof WorkerGlobalScope&&self instanceof WorkerGlobalScope?self:{},Prism=function(){var a=/\blang(?:uage)?-(?!\*)(\w+)\b/i,b=_self.Prism={util:{encode:function(k){return k instanceof d?new d(k.type,b.util.encode(k.content),k.alias):"Array"===b.util.type(k)?k.map(b.util.encode):k.replace(/&/g,"\x26amp;").replace(/</g,"\x26lt;").replace(/\u00a0/g," ")},type:function(b){return Object.prototype.toString.call(b).match(/\[object (\w+)\]/)[1]},clone:function(a){switch(b.util.type(a)){case "Object":var h=
{},c;for(c in a)a.hasOwnProperty(c)&&(h[c]=b.util.clone(a[c]));return h;case "Array":return a.map&&a.map(function(a){return b.util.clone(a)})}return a}},languages:{extend:function(a,h){var c=b.util.clone(b.languages[a]),e;for(e in h)c[e]=h[e];return c},insertBefore:function(a,h,c,e){e=e||b.languages;var d=e[a];if(2==arguments.length){c=arguments[1];for(var f in c)c.hasOwnProperty(f)&&(d[f]=c[f]);return d}var g={},m;for(m in d)if(d.hasOwnProperty(m)){if(m==h)for(f in c)c.hasOwnProperty(f)&&(g[f]=c[f]);
g[m]=d[m]}return b.languages.DFS(b.languages,function(b,c){c===e[a]&&b!=a&&(this[b]=g)}),e[a]=g},DFS:function(a,h,c){for(var e in a)a.hasOwnProperty(e)&&(h.call(a,e,a[e],c||e),"Object"===b.util.type(a[e])?b.languages.DFS(a[e],h):"Array"===b.util.type(a[e])&&b.languages.DFS(a[e],h,e))}},plugins:{},highlightAll:function(a,h){for(var c,e=document.querySelectorAll('code[class*\x3d"language-"], [class*\x3d"language-"] code, code[class*\x3d"lang-"], [class*\x3d"lang-"] code'),d=0;c=e[d++];)b.highlightElement(c,
!0===a,h)},highlightElement:function(k,h,c){for(var e,d,f=k;f&&!a.test(f.className);)f=f.parentNode;f&&(e=(f.className.match(a)||[,""])[1],d=b.languages[e]);k.className=k.className.replace(a,"").replace(/\s+/g," ")+" language-"+e;f=k.parentNode;/pre/i.test(f.nodeName)&&(f.className=f.className.replace(a,"").replace(/\s+/g," ")+" language-"+e);var f=k.textContent,g={element:k,language:e,grammar:d,code:f};if(!f||!d)return void b.hooks.run("complete",g);(b.hooks.run("before-highlight",g),h&&_self.Worker)?
(k=new Worker(b.filename),k.onmessage=function(a){g.highlightedCode=a.data;b.hooks.run("before-insert",g);g.element.innerHTML=g.highlightedCode;c&&c.call(g.element);b.hooks.run("after-highlight",g);b.hooks.run("complete",g)},k.postMessage(JSON.stringify({language:g.language,code:g.code,immediateClose:!0}))):(g.highlightedCode=b.highlight(g.code,g.grammar,g.language),b.hooks.run("before-insert",g),g.element.innerHTML=g.highlightedCode,c&&c.call(k),b.hooks.run("after-highlight",g),b.hooks.run("complete",
g))},highlight:function(a,h,c){a=b.tokenize(a,h);return d.stringify(b.util.encode(a),c)},tokenize:function(a,d,c){c=b.Token;var e=[a],l=d.rest;if(l){for(var f in l)d[f]=l[f];delete d.rest}a:for(f in d)if(d.hasOwnProperty(f)&&d[f])for(var l=d[f],l="Array"===b.util.type(l)?l:[l],g=0;g<l.length;++g)for(var m=l[g],n=m.inside,w=!!m.lookbehind,v=0,x=m.alias,m=m.pattern||m,u=0;u<e.length;u++){var q=e[u];if(e.length>a.length)break a;if(!(q instanceof c)){m.lastIndex=0;var p=m.exec(q);if(p){w&&(v=p[1].length);
var t=p.index-1+v,p=p[0].slice(v),r=t+p.length,t=q.slice(0,t+1),q=q.slice(r+1),r=[u,1];t&&r.push(t);p=new c(f,n?b.tokenize(p,n):p,x);r.push(p);q&&r.push(q);Array.prototype.splice.apply(e,r)}}}return e},hooks:{all:{},add:function(a,d){var c=b.hooks.all;c[a]=c[a]||[];c[a].push(d)},run:function(a,d){var c=b.hooks.all[a];if(c&&c.length)for(var e,l=0;e=c[l++];)e(d)}}},d=b.Token=function(a,b,c){this.type=a;this.content=b;this.alias=c};if(d.stringify=function(a,h,c){if("string"==typeof a)return a;if("Array"===
b.util.type(a))return a.map(function(b){return d.stringify(b,h,a)}).join("");c={type:a.type,content:d.stringify(a.content,h,c),tag:"span",classes:["token",a.type],attributes:{},language:h,parent:c};if("comment"==c.type&&(c.attributes.spellcheck="true"),a.alias){var e="Array"===b.util.type(a.alias)?a.alias:[a.alias];Array.prototype.push.apply(c.classes,e)}b.hooks.run("wrap",c);var e="",l;for(l in c.attributes)e+=(e?" ":"")+l+'\x3d"'+(c.attributes[l]||"")+'"';return"\x3c"+c.tag+' class\x3d"'+c.classes.join(" ")+
'" '+e+"\x3e"+c.content+"\x3c/"+c.tag+"\x3e"},!_self.document)return _self.addEventListener?(_self.addEventListener("message",function(a){a=JSON.parse(a.data);var d=a.language,c=a.immediateClose;_self.postMessage(b.highlight(a.code,b.languages[d],d));c&&_self.close()},!1),_self.Prism):_self.Prism;var n=document.getElementsByTagName("script");return n=n[n.length-1],n&&(b.filename=n.src,document.addEventListener&&!n.hasAttribute("data-manual")&&document.addEventListener("DOMContentLoaded",b.highlightAll)),
...
alias:"builtin"},punctuation:/[{}():,¬«»《》]/};Prism.languages.aspnet=Prism.languages.extend("markup",{"page-directive tag":{pattern:/<%\s*@.*%>/i,inside:{"page-directive tag":/<%\s*@\s*(?:Assembly|Control|Implements|Import|Master(?:Type)?|OutputCache|Page|PreviousPageType|Reference|Register)?|%>/i,rest:Prism.languages.markup.tag.inside}},"directive tag":{pattern:/<%.*%>/i,inside:{"directive tag":/<%\s*?[$=%#:]{0,2}|%>/i,rest:Prism.languages.csharp}}});Prism.languages.aspnet.tag.pattern=/<(?!%)\/?[^\s>\/]+(?:\s+[^\s>\/=]+(?:=(?:("|')(?:\\\1|\\?(?!\1)[\w\W])*\1|[^\s'">=]+))?)*\s*\/?>/i;
...
(function(a){var b={variable:[{pattern:/\$?\(\([\w\W]+?\)\)/,inside:{variable:[{pattern:/(^\$\(\([\w\W]+)\)\)/,lookbehind:!0},/^\$\(\(/],number:/\b-?(?:0x[\dA-Fa-f]+|\d*\.?\d+(?:[Ee]-?\d+)?)\b/,operator:/--?|-=|\+\+?|\+=|!=?|~|\*\*?|\*=|\/=?|%=?|<<=?|>>=?|<=?|>=?|==?|&&?|&=|\^=?|\|\|?|\|=|\?|:/,punctuation:/\(\(?|\)\)?|,|;/}},{pattern:/\$\([^)]+\)|`[^`]+`/,inside:{variable:/^\$\(|^`|\)$|`$/}},/\$(?:[a-z0-9_#\?\*!@]+|\{[^}]+\})/i]};a.languages.bash={shebang:{pattern:/^#!\s*\/bin\/bash|^#!\s*\/bin\/sh/,
...
operator:/<[=>]?|>=?|[+\-*\/^=&]|\b(?:AND|EQV|IMP|NOT|OR|XOR)\b/i,punctuation:/[,;:()]/};Prism.languages.c=Prism.languages.extend("clike",{keyword:/\b(asm|typeof|inline|auto|break|case|char|const|continue|default|do|double|else|enum|extern|float|for|goto|if|int|long|register|return|short|signed|sizeof|static|struct|switch|typedef|union|unsigned|void|volatile|while)\b/,operator:/\-[>-]?|\+\+?|!=?|<<?=?|>>?=?|==?|&&?|\|?\||[~^%?*\/]/,number:/\b-?(?:0x[\da-f]+|\d*\.?\d+(?:e[+-]?\d+)?)[ful]*\b/i});
...
/("|')(\\?.)*?\1/],number:/\b-?(0x[\da-f]+|\d*\.?\d+f?)\b/i});Prism.languages.insertBefore("csharp","keyword",{preprocessor:{pattern:/(^\s*)#.*/m,lookbehind:!0,alias:"property",inside:{directive:{pattern:/(\s*#)\b(define|elif|else|endif|endregion|error|if|line|pragma|region|undef|warning)\b/,lookbehind:!0,alias:"keyword"}}}});
...
(function(a){var b=/#(?!\{).+/,d={pattern:/#\{[^}]+\}/,alias:"variable"};a.languages.coffeescript=a.languages.extend("javascript",{comment:b,string:[/'(?:\\?[^\\])*?'/,{pattern:/"(?:\\?[^\\])*?"/,inside:{interpolation:d}}],keyword:/\b(and|break|by|catch|class|continue|debugger|delete|do|each|else|extend|extends|false|finally|for|if|in|instanceof|is|isnt|let|loop|namespace|new|no|not|null|of|off|on|or|own|return|super|switch|then|this|throw|true|try|typeof|undefined|unless|until|when|while|window|with|yes|yield)\b/,"class-member":{pattern:/@(?!\d)\w+/,
alias:"variable"}});a.languages.insertBefore("coffeescript","comment",{"multiline-comment":{pattern:/###[\s\S]+?###/,alias:"comment"},"block-regex":{pattern:/\/{3}[\s\S]*?\/{3}/,alias:"regex",inside:{comment:b,interpolation:d}}});a.languages.insertBefore("coffeescript","string",{"inline-javascript":{pattern:/`(?:\\?[\s\S])*?`/,inside:{delimiter:{pattern:/^`|`$/,alias:"punctuation"},rest:a.languages.javascript}},"multiline-string":[{pattern:/'''[\s\S]*?'''/,alias:"string"},{pattern:/"""[\s\S]*?"""/,
alias:"string",inside:{interpolation:d}}]});a.languages.insertBefore("coffeescript","keyword",{property:/(?!\d)\w+(?=\s*:(?!:))/})})(Prism);
...
{regex:[{pattern:/%r([^a-zA-Z0-9\s\{\(\[<])(?:[^\\]|\\[\s\S])*?\1[gim]{0,3}/,inside:{interpolation:b}},{pattern:/%r\((?:[^()\\]|\\[\s\S])*\)[gim]{0,3}/,inside:{interpolation:b}},{pattern:/%r\{(?:[^#{}\\]|#(?:\{[^}]+\})?|\\[\s\S])*\}[gim]{0,3}/,inside:{interpolation:b}},{pattern:/%r\[(?:[^\[\]\\]|\\[\s\S])*\][gim]{0,3}/,inside:{interpolation:b}},{pattern:/%r<(?:[^<>\\]|\\[\s\S])*>[gim]{0,3}/,inside:{interpolation:b}},{pattern:/(^|[^/])\/(?!\/)(\[.+?]|\\.|[^/\r\n])+\/[gim]{0,3}(?=\s*($|[\r\n,.;})]))/,
...
operator:[/\*\*|\/\/|=>|[=\/]=|[<>]=?|::|[+\-*=%]|\.(?:EQ|NE|LT|LE|GT|GE|NOT|AND|OR|EQV|NEQV)\.|\.[A-Z]+\./i,{pattern:/(^|(?!\().)\/(?!\))/,lookbehind:!0}],punctuation:/\(\/|\/\)|[(),;:&]/};Prism.languages.git={comment:/^#.*/m,deleted:/^[-–].*/m,inserted:/^\+.*/m,string:/("|')(\\?.)*?\1/m,command:{pattern:/^.*\$ git .*$/m,inside:{parameter:/\s(--|-)\w+/m}},coord:/^@@.*@@$/m,commit_sha1:/^commit \w{40}$/m};
...
Prism.languages.groovy=Prism.languages.extend("clike",{keyword:/\b(as|def|in|abstract|assert|boolean|break|byte|case|catch|char|class|const|continue|default|do|double|else|enum|extends|final|finally|float|for|goto|if|implements|import|instanceof|int|interface|long|native|new|package|private|protected|public|return|short|static|strictfp|super|switch|synchronized|this|throw|throws|trait|transient|try|void|volatile|while)\b/,string:/("""|''')[\W\w]*?\1|("|'|\/)(?:\\?.)*?\2|(\$\/)(\$\/\$|[\W\w])*?\/\$/,
number:/\b(?:0b[01_]+|0x[\da-f_]+(?:\.[\da-f_p\-]+)?|[\d_]+(?:\.[\d_]+)?(?:e[+-]?[\d]+)?)[glidf]?\b/i,operator:{pattern:/(^|[^.])(~|==?~?|\?[.:]?|\*(?:[.=]|\*=?)?|\.[@&]|\.\.<|\.{1,2}(?!\.)|-[-=>]?|\+[+=]?|!=?|<(?:<=?|=>?)?|>(?:>>?=?|=)?|&[&=]?|\|[|=]?|\/=?|\^=?|%=?)/,lookbehind:!0},punctuation:/\.+|[{}[\];(),:$]/});Prism.languages.insertBefore("groovy","string",{shebang:{pattern:/#!.+/,alias:"comment"}});Prism.languages.insertBefore("groovy","punctuation",{"spock-block":/\b(setup|given|when|then|and|cleanup|expect|where):/});
Prism.languages.insertBefore("groovy","function",{annotation:{pattern:/(^|[^.])@\w+/,lookbehind:!0}});Prism.hooks.add("wrap",function(a){if("groovy"===a.language&&"string"===a.type){var b=a.content[0];if("'"!=b){var d=/([^\\])(\$(\{.*?\}|[\w\.]+))/;"$"===b&&(d=/([^\$])(\$(\{.*?\}|[\w\.]+))/);a.content=Prism.highlight(a.content,{expression:{pattern:d,lookbehind:!0,inside:Prism.languages.groovy}});a.classes.push("/"===b?"regex":"gstring")}}});
...
lookbehind:!0}});
Prism.languages.lua={comment:/^#!.+|--(?:\[(=*)\[[\s\S]*?\]\1\]|.*)/m,string:/(["'])(?:(?!\1)[^\\\r\n]|\\z(?:\r\n|\s)|\\(?:\r\n|[\s\S]))*\1|\[(=*)\[[\s\S]*?\]\2\]/,number:/\b0x[a-f\d]+\.?[a-f\d]*(?:p[+-]?\d+)?\b|\b\d+(?:\.\B|\.?\d*(?:e[+-]?\d+)?\b)|\B\.\d+(?:e[+-]?\d+)?\b/i,keyword:/\b(?:and|break|do|else|elseif|end|false|for|function|goto|if|in|local|nil|not|or|repeat|return|then|true|until|while)\b/,"function":/(?!\d)\w+(?=\s*(?:[({]))/,operator:[/[-+*%^&|#]|\/\/?|<[<=]?|>[>=]?|[=~]=?/,{pattern:/(^|[^.])\.\.(?!\.)/,
...
Prism.languages.markup&&(Prism.hooks.add("before-highlight",function(a){"php"===a.language&&(a.tokenStack=[],a.backupCode=a.code,a.code=a.code.replace(/(?:<\?php|<\?)[\w\W]*?(?:\?>)/gi,function(b){return a.tokenStack.push(b),"{{{PHP"+a.tokenStack.length+"}}}"}))}),Prism.hooks.add("before-insert",function(a){"php"===a.language&&(a.code=a.backupCode,delete a.backupCode)}),Prism.hooks.add("after-highlight",function(a){if("php"===a.language){for(var b,d=0;b=a.tokenStack[d];d++)a.highlightedCode=a.highlightedCode.replace("{{{PHP"+
(d+1)+"}}}",Prism.highlight(b,a.grammar,"php").replace(/\$/g,"$$$$"));a.element.innerHTML=a.highlightedCode}}),Prism.hooks.add("wrap",function(a){"php"===a.language&&"markup"===a.type&&(a.content=a.content.replace(/(\{\{\{PHP[0-9]+\}\}\})/g,'\x3cspan class\x3d"token php"\x3e$1\x3c/span\x3e'))}),Prism.languages.insertBefore("php","comment",{markup:{pattern:/<[^?]\/?(.*?)>/,inside:Prism.languages.markup},php:/\{\{\{PHP[0-9]+\}\}\}/}));
...
lookbehind:!0}}}],"multiline-comment":{pattern:/(^|[^\\])\/\*[\s\S]*?\*\//,lookbehind:!0,alias:"comment"},regex:{pattern:/((?:\bnode\s+|[^\s\w\\]\s*))\/(?:[^\/\\]|\\[\s\S])+\/(?:[imx]+\b|\B)/,lookbehind:!0,inside:{"extended-regex":{pattern:/^\/(?:[^\/\\]|\\[\s\S])+\/[im]*x[im]*$/,inside:{comment:/#.*/}}}},comment:{pattern:/(^|[^\\])#.*/,lookbehind:!0},string:{pattern:/(["'])(?:\$\{(?:[^'"}]|(["'])(?:(?!\2)[^\\]|\\[\s\S])*\2)+\}|(?!\1)[^\\]|\\[\s\S])*\1/,inside:{"double-quoted":{pattern:/^"[\s\S]*"$/,
...
punctuation:/[$%@.(){}\[\];,\\]/};
Prism.languages.scala=Prism.languages.extend("java",{keyword:/<-|=>|\b(?:abstract|case|catch|class|def|do|else|extends|final|finally|for|forSome|if|implicit|import|lazy|match|new|null|object|override|package|private|protected|return|sealed|self|super|this|throw|trait|try|type|val|var|while|with|yield)\b/,string:/"""[\W\w]*?"""|"(?:[^"\\\r\n]|\\.)*"|'(?:[^\\\r\n']|\\.[^\\']*)'/,builtin:/\b(?:String|Int|Long|Short|Byte|Boolean|Double|Float|Char|Any|AnyRef|AnyVal|Unit|Nothing)\b/,number:/\b(?:0x[\da-f]*\.?[\da-f]+|\d*\.?\d+e?\d*[dfl]?)\b/i,
symbol:/'[^\d\s\\]\w*/});delete Prism.languages.scala["class-name"];delete Prism.languages.scala["function"];
...
"boolean":/\b(?:TRUE|FALSE|NULL)\b/i,number:/\b-?(?:0x)?\d*\.?[\da-f]+\b/,operator:/[-+*\/=%^~]|&&?|\|?\||!=?|<(?:=>?|<|>)?|>[>=]?|\b(?:AND|BETWEEN|IN|LIKE|NOT|OR|IS|DIV|REGEXP|RLIKE|SOUNDS LIKE|XOR)\b/i,punctuation:/[;[\]()`,.]/};
...
(function(){"undefined"!=typeof self&&self.Prism&&self.document&&Prism.hooks.add("complete",function(a){if(a.code){var b=a.element.parentNode,d=/\s*\bline-numbers\b\s*/;if(b&&/pre/i.test(b.nodeName)&&!a.element.querySelector(".line-numbers-rows")){d.test(a.element.className)&&(a.element.className=a.element.className.replace(d,""));d.test(b.className)||(b.className+=" line-numbers");var d=a.code.match(/\n(?!$)/g),n=Array((d?d.length+1:1)+1),n=n.join("\x3cspan\x3e\x3c/span\x3e"),d=document.createElement("span");
d.className="line-numbers-rows";d.innerHTML=n;b.hasAttribute("data-start")&&(b.style.counterReset="linenumber "+(parseInt(b.getAttribute("data-start"),10)-1));a.element.appendChild(d)}}})})();