...
CKEDITOR.editorConfig = function( config ) {
	...
	config.imageUploadUrl = "/dashboard/upload";
...
// 	config.extraPlugins = 'amwimagebrowser,onchange,stylesheetparser,markdown,embed,image2';
	config.extraPlugins = 'onchange,stylesheetparser,markdown,embed,image2';
	config.removePlugins = 'pbckcode';
	
// 	config.imageBrowser_listUrl = "/ccm_files/cklist/" + new Date;
	
	config.stylesSet = [];
	config.contentsCss = '/2016/css-compiled/compiled.css';
